  ...
  return (
    <div>
      <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        <nav className="flex flex-wrap justify-center item-center -mx-5 -my-2">
          <div className="px-5 py-2">
            <Link href="/home">
              <span className="text-base leading-6 text-gray-500 hover:text-gray-900 dark:hover:text-gray-300 ">
                Home
              </span>
            </Link>
          </div>
        ...
        <div className="flex justify-center mt-8 space-x-6">
          ...
          <a
            href="https://www.instagram.com/invites/contact/?i=14egkgyay9fyw&utm_content=h7ul57f"
            className="text-gray-400 hover:text-gray-500"
            target="blank"
          >
          ...
          {/* <a
            href="https://twitter.com/mansi_gundre?t=4e-TdM8sNb4QZCq2MlRpdA&s=08"
            className="text-gray-400 hover:text-gray-500"
            target="blank"
          >
        ...
        <p className="mt-2 text-base leading-6 text-center text-gray-400">
          &copy; {new Date().getFullYear()} Mansi. All rights
          reserved.
        </p>
      </div>
    </div>
