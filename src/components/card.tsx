    ...
    return (
        <li className="step shadow-3xl" data-aos="fade-up">
            ...
            <div className="content">
                <h3 className='text-xl font-bold'>{title}<div className='text-sm font-semibold'>{duration}</div></h3>
                {subtitle && <h4 className='text-md font-semibold'>{subtitle}</h4>}
                <p className='py-2'>
                    {description}
                </p>
                <div className="skills-container hidden sm:flex flex-wrap justify-center sm:justify-start">
